        ...
        <div class="container">
            ...
            <div class="wrapper d-flex align-items-stretch row">
                ...
                <div id="content" class="col">
                    ...
                    <div class="container">
                        <?php
                        $sqlCheckInProduction = "SELECT COUNT(*) AS count FROM orders WHERE is_received = 1 AND user_id = $user_id";
                        ...
                        if ($resultCheckInProduction) {
                            ...
                            if ($count > 0) {
                                ...
                                <div class="container d-flex align-items-center justify-content-center">
                                    <i class="fa-solid fa-check-to-slot" style="font-size: 34px;"></i>
                                </div>
                            
                                <div class="container d-flex align-items-center justify-content-center">    
                                    <h5 class="text-center">No Received orders</h5>
                                </div>
                                ';
                            }
                        } else {

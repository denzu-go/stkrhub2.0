...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sqlInsertWallet = "INSERT INTO wallet_transactions (user_id, transaction_type, amount, status, mode, unique_order_group_id) VALUES ('$user_id', 'Pay', '$encoded_paypal_payment', 'success', 'STKR Wallet Pay', '$unique_order_group_id')";

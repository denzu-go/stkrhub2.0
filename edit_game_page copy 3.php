    ...
    <script>
        $(document).ready(function() {
            ...
            $('#uploadForm').submit(function(event) {
                ...
                var built_game_id = $("#built_game_id").val();
                ...
                var desired_markup = $("#desired_markup").val();
                var desired_markup = $("#manufacturerProfitInput").val();
                var desired_markup = $("#creatorProfitInput").val();
                var desired_markup = $("#marketplacePriceInput").val();

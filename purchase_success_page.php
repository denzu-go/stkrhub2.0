    ...
    <section class="product_description_area" style="background: none;">
        <div class="container">
            ...
            <div class="container d-flex align-items-center justify-content-center">
                <i class="fa-solid fa-check-to-slot text-center" style="font-size: 44px; color: green"></i>
            </div>

            <div class="container d-flex align-items-center justify-content-center">
                <h5 class="text-center">Your order has been successfully purchased.</h5>
            </div>

            <div class="container d-flex align-items-center justify-content-center">
                <a href="profile_pending.php">Go to My Purchase page</a>
            </div>
        </div>
    </section>

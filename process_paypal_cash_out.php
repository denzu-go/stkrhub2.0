...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $sqlInsertWallet = "INSERT INTO wallet_transactions (user_id, transaction_type, amount, status, mode, paypal_transaction_id, paypal_email_destination, cash_out_fee) VALUES ('$user_id', 'Cash Out', '$encoded_cash_out_amount', 'pending', 'Paypal', '', '$paypal_email_destination', '$cash_out_fee')";

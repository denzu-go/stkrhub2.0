...
$faq_sql = "SELECT * from faq WHERE faq_id = $component_id";
...
<head>
    ...
    <title>STKR Admin - Help Category</title>
    <!-- Favicon icon -->
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Edit <?php echo $faq_row['faq_category']; ?></h4>
                                ...
                                <div class="container my-5">
                                    <form method="post" id="myForm" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="category" name="category" value="<?php echo $faq_row['faq_category']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea name="description" rows="4" cols="50"><?php echo $faq_row['faq_description']; ?></textarea>
                                            </div>
                                        </div>

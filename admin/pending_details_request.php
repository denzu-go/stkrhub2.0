                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <p class="mb-0">Review each of the details that the creator inputted.</p>
                        </div>
                    </div>
                </div>
                <!-- row -->
                            ...
                            <div class="card-body">
                                ...
                                <table id="hasRequest" class="display">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>Approved Game ID</th>
                                            <th>Approved Game Name</th>
                                            <th>Creator ID</th>
                                            <th>Status</th>
                                            <th>Actions</th>
                                        </tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#hasRequest').DataTable({
                "oLanguage": {
                    "sEmptyTable": "No Approved Games are ready to be Published yet"
                },

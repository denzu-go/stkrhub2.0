                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>All STKR Wallet Transactions</h4>
                            <p class="mb-0">List of all STKR Wallet Transactions</p>
                        </div>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="walletTransactions" class="display" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>User ID</th>
                                            <th>Date</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#walletTransactions').DataTable({
                "oLanguage": {
                    "sEmptyTable": "No STKR Wallet transactions yet"
                },
                ...
                "ajax": {
                    "url": "admin_json_wallet_transactions.php",
                    data: {},
                    "dataSrc": ""
                },
                "columns": [{

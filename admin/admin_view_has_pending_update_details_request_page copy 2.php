            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        ...
                        <div class="container">
                            <div class="col-sm">
                                <button class="btn" id="approvePublish" data-published_built_game_id="<?php echo $published_built_game_id; ?>" style="background-color: #63d19e; color: white;">Approve Publish
                                    Request</button>

                                <button class="btn" id="denyUpdate" data-published_built_game_id="<?php echo $published_built_game_id; ?>" style="background-color: #dc3545; color: white;">Deny Publish
                                    Request</button>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#denyUpdate').on('click', function() {
                const published_built_game_id = $(this).data('published_built_game_id');
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        ...
                        formData.append('publishedGameId', published_built_game_id);
